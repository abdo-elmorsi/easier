...
import { Filter } from "components/pages/monthly-report";
...
const Index = () => {
    ...
    const { data: tableData, isLoading } = useApi(queryString.includes("tower_id") ? `/reports/monthly-report?${queryString}` : "");
    ...
    const handleExportExcel = async () => {
        ...
        await exportExcel(tableData, columns, t("monthly_report_key"), handleMessage);
        setTimeout(() => {
