...
export const handleRegister = async (req, res) => {
	...
	try {
		...
		if (existingUser) throw new Error("Username already taken try another one!");
...
export const handleLogin = async (req, res) => {
	...
	// Validate input
	if (!password || (!user_name && (!number || !floor))) throw new Error("Invalid input: All fields are required");
