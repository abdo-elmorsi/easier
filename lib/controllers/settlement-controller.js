...
export const handleGetRequest = async (req, res) => {
  try {
    ...
    if (!tower) throw ErrorHandler.badRequest("Tower query is required to retrieve settlement");
    ...
    if (!items.length) throw ErrorHandler.notFound("No settlement found for the given month");
